...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // ----------------------------------------------------
    // Render media cards into the container
    // ----------------------------------------------------
            ...
            card.innerHTML = `
                ...
                <div class="media-info">
                    ...
                    <p class="media-rating">
                        Average Rating: ${item.average_rating ?? 0} / 10 
    ...
    function applyFilters() {
        ...
        // Sorting
        switch (sort) {
            case "title-asc":  filtered.sort((a,b)=>a.media_title.localeCompare(b.media_title)); break;
            case "title-desc": filtered.sort((a,b)=>b.media_title.localeCompare(a.media_title)); break;
            case "rating-desc": filtered.sort((a,b)=>(b.average_rating ?? 0) - (a.average_rating ?? 0)); break;
            case "rating-asc":  filtered.sort((a,b)=>(a.average_rating ?? 0) - (b.average_rating ?? 0)); break;
        }
