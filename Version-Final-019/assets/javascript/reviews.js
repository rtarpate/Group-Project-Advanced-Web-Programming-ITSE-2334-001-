      ...
      container.insertAdjacentHTML("beforeend", `
        <div class="media-card">
          ...
          <div class="media-info">
            ...
            <p class="media-type"><strong>Type:</strong> ${item.media_type}</p>
            <p class="media-description"><strong>Genre:</strong> ${item.genre_name || 'N/A'}</p>
            <p class="media-rating"><strong>Rating:</strong> ${avgText}</p>
