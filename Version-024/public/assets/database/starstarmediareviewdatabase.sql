...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2025 at 08:33 AM
...
CREATE TABLE `meidatable` (
  ...
  `MediaImage` varchar(500) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `meidatable` (`MediaID`, `Name`, `YearOfRelease`, `Director`, `Genre`, `Type`, `ContentRating`, `MediaImage`) VALUES
...
CREATE TABLE `reviewstable` (
  `MediaID` int(11) NOT NULL,
  `AverageRating` decimal(50,0) NOT NULL,
  `TotalRatings` int(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `reviewstable` (`MediaID`, `AverageRating`, `TotalRatings`) VALUES
(3, 3, 175),
(8, 4, 203);
...
INSERT INTO `userreviews` (`MediaID`, `ReviewID`, `Rating`, `ReviewText`, `ReviewDate`) VALUES
...
--
ALTER TABLE `reviewstable`
  ADD CONSTRAINT `reviewstable_ibfk_1` FOREIGN KEY (`MediaID`) REFERENCES `meidatable` (`MediaID`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `userreviews`
--
ALTER TABLE `userreviews`
  ADD CONSTRAINT `userreviews_ibfk_1` FOREIGN KEY (`MediaID`) REFERENCES `meidatable` (`MediaID`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
