...
// If you want to clean inputs later, you can also use helper.php here:
...
// DEBUG HELPER
//--------------------------------------
define('ADMIN_ADD_MEDIA_DEBUG', true);  // set to false later to hide debug
