document.addEventListener('DOMContentLoaded', () => {
  ...
  function applySearchAndTypeFilter() {
        ...
        const t = typeFilter.value; // movie, video_game, etc.

        filteredMedia = allMedia.filter(media => {

            // If a type is selected, skip non-matching items
            const typeMatch = (t === "all") || (media.media_type.toLowerCase() === t.toLowerCase());
