...
try {
    switch ($action) {
        ...
        // =====================================
        // 1) RETURN MEDIA FOR REVIEWS PAGE
        // =====================================
        case 'getMedia':
        ...
        // =====================================
        // 2) REQUEST NEW MEDIA (request-new-media.html)
        // =====================================
        case 'submitNewMedia':
        ...
        // =====================================
        // 3) WRITE-A-REVIEW FORM (write-review.html)
        // =====================================
        case 'submitReview':
        ...
        case 'getMediaDetails':
            ...
            $data = StarStarMediaDatabase::getMediaDetails($mediaId);
        ...
        case 'getMediaReviews':
            ...
            $data = StarStarMediaDatabase::getMediaReviews($mediaId);
