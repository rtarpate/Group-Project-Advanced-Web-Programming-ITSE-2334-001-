// ===============================================
// reviews.js - Dynamic filtering & sorting
// ===============================================
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const resetBtn       = document.getElementById("reset-filters"); // We will add this in HTML
    ...
    function applyFilters() {
        ...
        let filtered = mediaList.filter(item => {
            ...
            // Type match
            const typeMatch = (typeVal === "all") || (item.media_type === typeVal);

            // Genre match
            const genreMatch = (genreVal === "all") || (item.genre_name === genreVal);

            // Content Rating match
            const ratingMatch = (ratingVal === "all") || (item.content_rating === ratingVal);
        ...
        switch (sortVal) {
            ...
            case "newest": // based on release_date
            ...
            case "id-desc": // newest added to DB
                filtered.sort((a, b) => b.media_id - a.media_id);
                break;

            case "id-asc": // earliest added
